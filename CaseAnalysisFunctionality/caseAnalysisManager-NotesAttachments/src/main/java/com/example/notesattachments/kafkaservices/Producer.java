package com.example.notesattachments.kafkaservices;
...
public class Producer {
	...
	public void producerData(String module , String data , String key)
	{
		...
		ProducerRecord<String, String> record = new ProducerRecord<String, String>("CaseAnalysisAuditTopic", key , data);
